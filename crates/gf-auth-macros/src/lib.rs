//! Modified version of [serde_tuple](https://crates.io/crates/serde_tuple),
...
pub fn derive_serialize_tuple(input: TokenStream) -> TokenStream {
  ...
  let out = quote! {
      impl #impl_generics gf_auth_traits::SerializeTuple for #ident #ty_generics #where_clause {
...
pub fn derive_deserialize_tuple(input: TokenStream) -> TokenStream {
  ...
  let out = quote! {
      impl #de_impl_generics gf_auth_traits::DeserializeTuple<'de> for #ident #ty_generics #where_clause {
